            ...
            _export('DateHelper', DateHelper = function () {
                ...
                _createClass(DateHelper, null, [{
                    ...
                    value: function textoParaData(texto) {
                        if (!/\d{2}\/\d{2}\/\d{4}/.test(texto)) throw new Error('Formato da data deve ser dd/mm/aaaa');
                        return new (Function.prototype.bind.apply(Date, [null].concat(_toConsumableArray(texto.split('/').reverse().map(function (item, idx) {
                            return item - idx % 2;
                        })))))();
                    }
                }, {
